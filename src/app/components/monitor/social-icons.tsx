...
const cardBase =
  'relative flex h-14 w-32 xs:h-16 xs:w-36 sm:h-20 sm:w-48 items-center justify-center rounded-xl bg-paper hover:bg-button-bg flex-shrink-0  my-4';
...
const SocialIcons: FC = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-x-1 overflow-x-auto xs:gap-x-2 sm:gap-x-4 2xl:flex-row">
      <Link
      ...
      <Link href="https://bvc.citizenweb3.com" className={cardBase} aria-label="BVC" title="BVC">
        ...
        <span className="absolute right-2 top-2 h-2 w-2 rounded-full bg-yellow xs:right-3 xs:top-3" />
      </Link>
