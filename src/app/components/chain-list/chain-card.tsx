...
const ChainCard: FC<OwnProps> = ({ chain }) => {
  ...
  return (
    <div className="group flex w-full flex-row rounded-3xl bg-paper p-4 shadow transition-all duration-300 hover:scale-105 hover:brightness-150 active:scale-95 active:brightness-75">
      {/*<div className="mb-2 flex items-start gap-2">*/}
      {/*  <div className="ml-auto h-1 w-1 animate-ping rounded-full bg-green" />*/}
      {/*</div>*/}
      <Link href={`/chains/${chain.name}`} className="flex">
