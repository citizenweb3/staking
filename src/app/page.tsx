...
const Home = async () => {
  ...
  return (
    <div>
      <h2 id="mainnets" className="text-3xl font-semibold">
        Mainnets
      </h2>
      <ChainList chains={chains} category={'mainnet'} />
      <h2 id="testnets" className="mt-12 text-3xl font-semibold">
        Testnets
      </h2>
      <ChainList chains={chains} category={'testnet'} />
      <h2 id="infra" className="mt-12 text-3xl font-semibold">
        Only infra
      </h2>
