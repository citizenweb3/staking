...
export const metadata: Metadata = {
  title: 'Public Monitor Citizen Web3 Validator: Non-Custodial Staking',
  description:
    'Stake securely with Citizen Web3, a non-custodial, self-hosted bare-metal validator. Focused on Privacy networks. Offering public endpoints, archives, snapshots, and relayers. Off-the-grid infrastructure in the Atlantic Ocean for decentralized blockchain validation and rewards.',
};
...
const RootLayout: FC<PropsWithChildren> = ({ children }) => {
  return (
    <html lang="en" className={`${fontMain.variable} ${hisqaida.variable}`}>
      <head>
        <title>Public Monitor Citizen Web3 Validator: Non-Custodial Staking</title>
        ...
        <meta property="og:title" content="Public Monitor Citizen Web3 Validator: Non-Custodial Staking" />
        <meta
        ...
        <meta name="twitter:title" content="Public Monitor Citizen Web3 Validator: Non-Custodial Staking" />
        <meta
